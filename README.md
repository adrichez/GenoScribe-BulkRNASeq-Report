...
<div align="center">
  <h1><span style="color: #6caef1;">Ejemplo de Informe de Bulk RNA-Seq generado con GenoScribe</span></h1>
...
Este repositorio es un **ejemplo de informe de Bulk RNA-Seq generado con GenoScribe**, diseñado para mostrar de manera accesible las capacidades del sistema de generación de informes.  
...
El **Bulk RNA-Seq** es una técnica de secuenciación de ARN que permite medir la **expresión génica promedio de todas las células de una muestra**, a diferencia del RNA-Seq de célula única.  

🔹 **Aplicaciones principales del Bulk RNA-Seq:**  
- 📊 Comparación de expresión génica entre condiciones (tratado vs. control).  
